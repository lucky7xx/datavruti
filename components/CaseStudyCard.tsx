  ...
  return (
    <Link href={`/case-studies/${slug}`} className="block group h-full">
      <div className="relative h-full">
        ...
        <div className="relative bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-neutral-100 h-full flex flex-col">
