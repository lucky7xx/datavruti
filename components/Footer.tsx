        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-5">
            <div className="flex items-center space-x-3 mb-6 group">
              ...
              <div>
                ...
                <div className="text-[10px] text-neutral-400 -mt-1 font-medium tracking-wide">DATA HIRING EXPERTS</div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              {/* Social media links - rotated colors: red, orange, blue */}
              <a href="#" className="group relative w-11 h-11 bg-slate-800 hover:bg-gradient-to-br hover:from-primary-600 hover:to-primary-700 rounded-xl flex items-center justify-center text-neutral-400 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-primary-500/30 hover:scale-110 transform overflow-hidden" aria-label="Facebook">
              ...
              <a href="#" className="group relative w-11 h-11 bg-slate-800 hover:bg-gradient-to-br hover:from-secondary-600 hover:to-secondary-700 rounded-xl flex items-center justify-center text-neutral-400 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-secondary-500/30 hover:scale-110 transform overflow-hidden" aria-label="Twitter">
                <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-700"></span>
                <svg className="relative h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                </svg>
              </a>
              <a href="#" className="group relative w-11 h-11 bg-slate-800 hover:bg-gradient-to-br hover:from-accent-600 hover:to-accent-700 rounded-xl flex items-center justify-center text-neutral-400 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-accent-500/30 hover:scale-110 transform overflow-hidden" aria-label="LinkedIn">
                <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-700"></span>
                <svg className="relative h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-span-1 md:col-span-4">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+911234567890" className="text-neutral-400 hover:text-white transition-all duration-200 flex items-start gap-3 group">
                  <div className="w-10 h-10 bg-slate-800 group-hover:bg-accent-600 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-300">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
